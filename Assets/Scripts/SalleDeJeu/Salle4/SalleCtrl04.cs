namespace SalleDeJeu
{
    ...
    public class SalleCtrl04 : LogiqueDesSallesDeJeu
    {
        ...
        public override bool CalculeBooleen()
        {
            ...
            _resultatColonneNO1_3 = !objectActionnableList[4].AvoirEstActivé();
            ...
            _resultatColonneXNOR2_2 = ComparateurBooleen(BooleanOperation.nonOuExclusif_XNOR, _resultatColonneNO1_3, objectActionnableList[5].AvoirEstActivé());
